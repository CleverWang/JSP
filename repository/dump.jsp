...
<body>
     <div class="text-center">
      <header>
        <div class="sign" style="text-align: left">
		  <h1><center><font color="white">商品信息修改系统</font></center><h1>
        </div>
      </header>
	 <div>
	 <br>
	 ...
	 if(operationMan==null){%>
      ...
      <form class="" action="dumpservlet" method="post">
		...
		<p>商品型号:</p><input type="text" name="model" value="" placeholder="Model"><br>
	...
	修改系统反馈信息：<jsp:getProperty name="dump" property="backnews"/></font>
      <%}
	  else{%>
