...
strSQL = "select internalNum,man,breakdownReason,fixTime,fixMan,fixResult,fixBill from breakdown";//准备SQL语句
...
<div class="text-center">
      <header>
        <div class="sign" style="text-align: left">
		  <h1><center><font color="white">商品退货查询系统</font></center><h1>
        </div>
      </header>
	 <div><br>
